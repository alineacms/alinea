...
function withAs(Component: ComponentType<any>): ComponentType<any> {
...
export function createTypo(styles: TypoStyles, overrides: Overrides = {}) {
  function Typo({
    children,
    align
  }: PropsWithChildren<{align?: 'left' | 'right' | 'center'}>) {
    return (
  ...
  function H1Component(
    {as: Type = overrides.h1 ?? 'h1', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.h1(styler.merge(rest as any), {flat, light})}
      />
    )
  }

  function H2Component(
    {as: Type = overrides.h2 ?? 'h2', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.h2(styler.merge(rest as any), {flat, light})}
      />
    )
  }

  function H3Component(
    {as: Type = overrides.h3 ?? 'h3', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.h3(styler.merge(rest as any), {flat, light})}
      />
    )
  }

  function H4Component(
    {as: Type = overrides.h4 ?? 'h4', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.h4(styler.merge(rest as any), {flat, light})}
      />
    )
  }

  function H5Component(
    {as: Type = overrides.h5 ?? 'h5', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.h5(styler.merge(rest as any), {flat, light})}
      />
    )
  }

  function PComponent(
    {as: Type = overrides.p ?? 'p', flat, light, ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        ref={ref}
        {...rest}
        className={styles.p(styler.merge(rest as any), {flat, light})}
      />
    )
  }
  ...
  >(function LinkComponent(props, ref) {
    ...
    return (
      <Tag
        {...(props as any)}
        ref={ref}
        className={styles.link(styler.merge(props as any))}
      />
    )
  })

  function MonospaceComponent(
    {as: Type = 'span', ...rest}: {as?: ComponentType<any> | string},
    ref: any
  ) {
    return (
      <Type
        {...(rest as any)}
        ref={ref}
        className={styles.monospace(styler.merge(rest as any))}
      />
    )
  }

  function SmallComponent(
    {as: Type = overrides.small ?? 'small', ...rest}: TypoHeadingProps,
    ref: any
  ) {
    return (
      <Type
        {...(rest as any)}
        className={styles.small(styler.merge(rest as any))}
        ref={ref}
      />
    )
  }
