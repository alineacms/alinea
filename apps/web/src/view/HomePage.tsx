...
import {IcRoundFastForward} from '../icons/IcRoundFastForward.js'
import {MdiLanguageTypescript} from '../icons/MdiLanguageTypescript.js'
import heroBg from '../media/hero.jpg'
import {Blocks} from './blocks/Blocks.js'
import {CodeVariantsBlock} from './blocks/CodeVariantsBlock.js'
import css from './HomePage.module.scss'
import {Newsletter} from './layout/engage/Newsletter.js'
        ...
        <Layout.Container>
          <div className={styles.root.intro()}>
            ...
            <div className={styles.root.intro.code()}>
              ...
              <HStack center>
                <Stack.Right className={styles.root.intro.examples()}>
                  <HStack gap={25}>
