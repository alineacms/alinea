...
export function NumberInput() {
  ...
  const initialNumberInput = useField(
    number('Number (initial value: 100)', {
      initialValue: 100
    })
  )
  const minNumberInput = useField(
    number('Number (minimum value: 50)', {
      minValue: 50
    })
  )
  const maxNumberInput = useField(
    number('Number (maximum value: 500)', {
      maxValue: 500
    })
  )
  const minMaxNumberInput = useField(
    number('Number (minimum value: 50, maximum value: 500)', {
      minValue: 50,
      maxValue: 500
    })
  )
  const initialMinMaxNumberInput = useField(
    number(
      'Number (initial value: 100, minimum value: 50, maximum value: 500)',
      {
        initialValue: 100,
        minValue: 50,
        maxValue: 500
