export function HistoryDraftAlert() {
  return (
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          ...
          <div className="mt-2 text-sm text-blue-700">
            <p>
              You are viewing the current live version. A newer draft version is
              available. To make modifications, navigate to the draft entry or
